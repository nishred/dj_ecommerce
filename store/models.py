...
# in this collection,basically featured_product_id is stored

class Collection(models.Model):
    title = models.CharField(max_length=255)
    featured_product = models.ForeignKey(
        'Product', on_delete=models.SET_NULL, null=True, related_name='+', blank=True)  # "+" if you dont want to add a reverse relationship
